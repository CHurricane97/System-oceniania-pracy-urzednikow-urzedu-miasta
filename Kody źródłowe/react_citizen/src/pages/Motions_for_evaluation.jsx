...
export default function Motions_for_evaluation() {
    ...
    const getSearch = useCallback(() => {
        ...
        xHttp.open(
            "GET",
            `${appConfig.server}/motion/getAllFinishedForUser?page=${page}`,
            true,
            null,
            null
        );
